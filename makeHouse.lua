...
local function createWalls(length, width, height)
  for i=1, height do
    turtle.up()
    for j = 1, 4 do
...
local function createCeiling(length, width, height)
  for i=1, height+1 do
    turtle.up()
  end
...
local function createHouse(length, width, height)
  createFloor(length, width)
  createWalls(length, width, height)
  createCeiling(length, width, height)
  createDoor()
end
