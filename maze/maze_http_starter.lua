...
--**************************************************--
-- DOMAIN, PORT and DIRECTIONS constants go here!!!
--**************************************************--

--***************************************************************--
-- Add current "direction_index" variable initialization here!!!
--***************************************************************--
...
--*******************************************--
--  Add  HTTP Post utility function here!!
--
--  Objective: Figure out where to call the
--    broadcast method in the below code to
--    send information to the web page.
--  Hint: Stub broadcast method for testing
--*******************************************--
...
-- tunnel in the maze.
--**************************************************************--
--  Update this function to start tracking turtle direction.
--**************************************************************--
